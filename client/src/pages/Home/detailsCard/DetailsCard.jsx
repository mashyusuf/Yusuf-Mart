...
export default function DetailsCard() {
  return (
    <div className='mt-10 mb-10'>
        ...
        <div className='flex items-center space-x-2  rounded-md border px-2 py-4 shadow-md'>
            <div>
                <img src={img1} alt="" />
            </div>
            <div className=''>
                <h1 className='text-xl font-bold'>Payment only online</h1>
                <p className='text-sm text-gray-500'>Tasigförsamhet beteendedesign. Mobile <br />
                checkout. Ylig kärrtorpa.</p>
            </div>
        </div>
        <div className='flex items-center space-x-2 border-purple-400 rounded-md border px-2 py-4 shadow-md'>
            <div>
                <img src={img2} alt="" />
            </div>
            <div className=''>
